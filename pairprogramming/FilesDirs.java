...
class File {
  ...
  /*public static File createFileWithoutDisplayName(String number)
  {
...
class FileWithoutDisplayName extends File {
	...
	public static File createFileWithoutDisplayName(String name){
...
public class FilesDirs {
  public static void main(String[] args) {
    ...
    File a = File.createFile("aa"), b = File.createFile("bb"), c = File.createFile("cc"), 
         d = File.createFile("dd"), e = File.createFile("ee"), f = FileWithoutDisplayName.createFileWithoutDisplayName("12345");
    one.add(a);
    one.add(two);
    one.add(b);
    two.add(c);
